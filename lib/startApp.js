// import the classes to use later
...
class startApp {
    ...
    // Method that starts the app using the Manager class
    begin() {
        inquirer
            .prompt([
                {
    ...
    // Menu method to use later. Asks what to do next
    menu() {
        inquirer
            .prompt([
                {
                ...
                //if statements for intern, intern, or done
    ...
    // method for the engineer that uses the Engineer class
    engineerHTML() {
        inquirer
            .prompt([
                {
    ...
    // Method for the intern class that uses the Intern class
    internHTML() {
        inquirer
            .prompt([
                {
    ...
    // Finished the HTML for the page
    finishTeam() {
        const finalHtml = `
        </div>
